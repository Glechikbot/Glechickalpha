...
return """💥 Сьогодні — День виживання! Виконай усе: 📲 Зробити пост у інсту 🏋️ 20 присідань 🛍️ Назвати одну нову ідею для товару 🧠 Записати 3 речі, які тебе порадували сьогодні""""
