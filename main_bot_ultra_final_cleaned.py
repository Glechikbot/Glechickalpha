...
return f"""Dobryi ranok, glechyno! Sogodni zamist TikTok: 1) Vypyi vody 2) Lifehack: hack"""
3) Zavdannya: " + task + "

Napishy /done koli vykonaesh — +10 baliv."
...
return f"""💥 Сьогодні — День виживання! Виконай усе: 📲 Зробити пост у інсту 🏋️ 20 присідань 🛍️ Назвати одну нову ідею для товару 🧠 Записати 3 речі, які тебе порадували сьогодні"""

def build_lazy_check():
return f"""❓ Що з цього тебе зупинило сьогодні? """
".join(lazy_reasons)
